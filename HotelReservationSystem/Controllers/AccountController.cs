...
namespace HotelReservationSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
                ...
                case SignInStatus.Success:
                    {
                        ...
                        {
                            Session.Add("CustomerID", model.Name);
                        ...
                        {
                            Session.Add("ManagerID", model.Name);
        ...
        {
            //return RedirectToAction("Register", "Register", new { area = "Managers" });
            return View();
        }
        ...
        public async Task<ActionResult> Registers(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(model.Role.Contains("Customer"))
                          return RedirectToAction("Index", "Booking",new { area = "Customers" });
                    else if (model.Role.Contains("Manager"))
                             return RedirectToAction("Index", "Hotels", new { area = "Managers" });
                }
                AddErrors(result);
            }
